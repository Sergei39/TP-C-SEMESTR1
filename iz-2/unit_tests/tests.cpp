...
//TEST(TestStaticLib, MiddleMatrix){
//    const char* NAME_INPUT = "../unit_tests/test_files/middle_matrix.input";
//    const char* NAME_EXPECTED_OUTPUT = "../unit_tests/test_files/middle_matrix.output";
//    const char* NAME_OUTPUT = "../unit_tests/test_files/output.output";
//    matrix_reflection_file(NAME_INPUT, NAME_OUTPUT);
//
//    std::string line_expected, line_test;
...
//}
//
//TEST(TestStaticLib, BigMatrix){
//    const char* NAME_INPUT = "../unit_tests/test_files/big_matrix.input";
//    const char* NAME_EXPECTED_OUTPUT = "../unit_tests/test_files/big_matrix.output";
//    const char* NAME_OUTPUT = "../unit_tests/test_files/output.output";
//    matrix_reflection_file(NAME_INPUT, NAME_OUTPUT);
//
//    std::string line_expected, line_test;
...
TEST(TestStaticLib, IncorrectNameFile){
...
TEST(TestStaticLib, BrokenMatrix){
